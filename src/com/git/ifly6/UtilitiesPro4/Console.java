...
import com.git.ifly6.UtilitiesPro3.CommandCommands;
import com.git.ifly6.UtilitiesPro3.EditCommands;
import com.git.ifly6.UtilitiesPro3.FileCommands;
import com.git.ifly6.UtilitiesPro3.HelpCommands;
import com.git.ifly6.UtilitiesPro3.MacHandler;
import com.git.ifly6.UtilitiesPro3.Personal;
import com.git.ifly6.UtilitiesPro3.ScriptCommands;
import com.git.ifly6.UtilitiesPro3.TextCommands;
...
public class Console {
	...
	/**
	 * Initial instance of the programme. Used on the standard execution paths
	 * for the toolbar and stuff. There is another instance allotted for 2 tabs.
	 * 
	 * @since UtilitiesPro-dev-4.0
	 */
	public Console init = new Console();
	public Console tab1 = new Console();
	public Console tab2 = new Console();
