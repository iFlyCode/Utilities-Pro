...
import ifly6.UtilitiesPro2.copy.Parametres;
...
public class InfoMethods extends TextProc {
	...
	public static void acknowledgements() throws IOException {
		mkdir();
		String[] url = { "curl", "-o", UtilitiesPro_DIR + "/acknowledgements.txt",
				"http://ifly6.no-ip.org/Utilities Pro/acknowledgements.txt" };
		rt.exec(url);
		fstream = new FileReader(
				"/Users/" + userName + "/Library/Application Support/Utilities Pro/acknowledgements.txt");
	...
	public static void info() throws InterruptedException, IOException {
		...
		out(System.getProperty("java.runtime.name") + " version " + System.getProperty("java.runtime.version")
				+ System.getProperty("java.vm.version") + " by " + System.getProperty("java.vm.vendor"));
