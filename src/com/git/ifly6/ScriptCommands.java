...
public class ScriptCommands extends Console {
	...
	public static void purge(){
		...
		try {
			rt.exec(purge);
		} catch (IOException e) { log("Purge Failed"); }
	}
	
	/**
	 * @since iUtilities v1.0
	 * @Notes This is nearly word for word copied from iUtilities v1.0's implementation
	 */
	public static void wireless(){
		...
		} catch (IOException e) { log("Airport Restart Failed");
		} catch (InterruptedException e) { log("Airport Restart Failed"); }
	...
	/**
	 * @since 2.x (I think)
	 * @Notes This entire section here, is very messy. It has been pruned little since we just
	...
	public static void readout(){
		...
		} catch (IOException e) { log("Readout Failed"); }
	}
	public static void mindterm(){
		...
		try {
			rt.exec(url);
		} catch (IOException e) { log("Mindterm Download Failed"); }
		append("Mindterm Downloaded to: " + "/Users/" + userName + "/Downloads/" + 
