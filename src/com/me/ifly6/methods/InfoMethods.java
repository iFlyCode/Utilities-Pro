...
public class InfoMethods extends TextProc {
	...
	public static void acknowledgements() throws IOException{
		mkdir();
		String[] url = { "curl", "-o", UtilitiesPro_DIR + "/acknowledgements.txt", "http://ifly6.no-ip.org/Utilities Pro/acknowledgements.txt" };
		rt.exec(url);
		fstream = new FileReader("/Users/" + userName + "/Library/Application Support/Utilities Pro/acknowledgements.txt");
	...
	public static void changelog() throws IOException{
		mkdir();
		String[] url = { "curl","-o", UtilitiesPro_DIR + "/changelog.txt", "http://ifly6.no-ip.org/iUtilities/changelog.txt" };
		rt.exec(url);
		try{
			Thread.sleep(500);
	...
	public static void info() throws InterruptedException, IOException{
		...
		setText(null);
		append("Generated By: " + Parametres.version + " '" + Parametres.keyword + "' \n");
